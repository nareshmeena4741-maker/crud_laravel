...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'role:admin']], function () {
    ...
    Route::post('toggle/{id}', [AdminController::class, 'toggleActive'])->name('admin.user.toggle');

    Route::get('edit/{id}', [AdminController::class, 'editUserForm'])->name('admin.user.edit');
    Route::put('update/{id}', [AdminController::class, 'updateUser'])->name('admin.user.update');
    Route::delete('delete/{id}', [AdminController::class, 'deleteUser'])->name('admin.user.delete');
});
